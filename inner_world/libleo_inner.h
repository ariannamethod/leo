...
#line 19 "emotional_resonance.go"
...
extern float leo_get_valence();
extern float leo_get_arousal();
extern void leo_emotional_drift(float inputValence, float inputArousal);
