#!/usr/bin/env bash
# A.108: test whether a delayed boundary receipt survives the full signed path that followed it.
set -Eeuo pipefail

trap 'rc=$?; printf "road delayed-receipt-path runner failed: line=%s rc=%s command=%s\n" "$LINENO" "$rc" "$BASH_COMMAND" >&2; exit "$rc"' ERR

ROOT="$(cd "$(dirname "$0")/.." && pwd)"
CC="${CC:-cc}"
RESERVOIR="${LEO_STATE_RECEIPT_PATH_RESERVOIR_SOURCE:-/private/tmp/leo-state-swarm-receipt-path-reservoir-a108-r2-20260815}"
A101="${LEO_STATE_RECEIPT_PATH_A101_SOURCE:-/private/tmp/leo-state-swarm-road-error-memory-a101-r1-20260810}"
A103="${LEO_STATE_RECEIPT_PATH_A103_SOURCE:-/private/tmp/leo-state-swarm-road-episode-memory-a103-r2-20260813}"
A104="${LEO_STATE_RECEIPT_PATH_A104_SOURCE:-/private/tmp/leo-state-swarm-road-ordered-episode-a104-r1-20260813}"
A105="${LEO_STATE_RECEIPT_PATH_A105_SOURCE:-/private/tmp/leo-state-swarm-road-episode-consequence-a105-r1-20260813}"
A106="${LEO_STATE_RECEIPT_PATH_A106_SOURCE:-/private/tmp/leo-state-swarm-road-counterbalanced-consequence-a106-r2-20260813}"
A107="${LEO_STATE_RECEIPT_PATH_A107_SOURCE:-/private/tmp/leo-state-swarm-road-delayed-consequence-receipt-a107-r1-20260813}"
JOBS="${LEO_STATE_RECEIPT_PATH_JOBS:-4}"
AGGREGATE_ONLY="${LEO_STATE_RECEIPT_PATH_AGGREGATE_ONLY:-0}"
STAMP="$(date +%Y%m%d-%H%M%S)"
OUT="${1:-${TMPDIR:-/tmp}/leo-state-swarm-road-delayed-receipt-path-$STAMP}"

CANDIDATES="$ROOT/scripts/state_swarm_receipt_path_reservoir_candidates.tsv"
...
RESERVOIR_WRAPPER="$ROOT/scripts/state_swarm_receipt_path_reservoir_matrix.sh"
ELIGIBILITY_REPORTER="$ROOT/scripts/state_swarm_delayed_receipt_eligibility.awk"
RECEIPT_REPORTER="$ROOT/scripts/state_swarm_road_delayed_receipt_path_report.awk"
RECEIPT_LIFE="$ROOT/scripts/state_swarm_road_delayed_receipt_path_life.awk"
RECEIPT_SUMMARY="$ROOT/scripts/state_swarm_road_delayed_receipt_path_summary.awk"
RECEIPT_SELECTOR="$ROOT/scripts/state_swarm_road_delayed_receipt_path_select.awk"
RECEIPT_VERDICT="$ROOT/scripts/state_swarm_road_delayed_receipt_path_verdict.awk"
...
EXPECTED_CANDIDATES_SHA="${LEO_STATE_RECEIPT_PATH_CANDIDATES_SHA:-10862e0e46322d46534147929d15df2da8dc7c8ed7b82a8e5cde71df36578957}"
EXPECTED_WARM_CASES_SHA="${LEO_STATE_RECEIPT_PATH_WARM_CASES_SHA:-1f6e57f2ab55660b8a4cf2cc3e0a2769fa96ffd00ad0d8623e699b318acb4c0b}"
EXPECTED_WRITER_CASES_SHA="${LEO_STATE_RECEIPT_PATH_WRITER_CASES_SHA:-cfa13bb521d91a6a9f3db7fc278927f9120cd699fe72ce1a149307c170ea45e2}"
EXPECTED_REPORTER_SHA="${LEO_STATE_RECEIPT_PATH_REPORTER_SHA:-4667e61986b9fd43c62098786ddc28c9d79ecf5dfd1f74ecd1128b587005af80}"
EXPECTED_PLANNER_SHA="${LEO_STATE_RECEIPT_PATH_PLANNER_SHA:-2ccdaaeb73abad66c5f359dc927cb12a813a66f9489bf9017ba32728fd16b2a5}"
EXPECTED_PROSPECTIVE_SHA="${LEO_STATE_RECEIPT_PATH_PROSPECTIVE_SHA:-648c4202fc2c86d495b9e97568d9b982940beac7058f196f2c96fb9b40a9a181}"
EXPECTED_RESERVOIR_WRAPPER_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_WRAPPER_SHA:-df087a77bba530919b073a7f55f0e9f47f91e7d9351132277942f51dd34ab084}"
EXPECTED_ELIGIBILITY_REPORTER_SHA="${LEO_STATE_RECEIPT_PATH_ELIGIBILITY_REPORTER_SHA:-737dc716b751ab475cbafc0640a3eab47c8e8ce620d5c6aba3be1dbe4d67065b}"
EXPECTED_RECEIPT_REPORTER_SHA="${LEO_STATE_RECEIPT_PATH_RECEIPT_REPORTER_SHA:-79c01de29e36d7f8b3c84ce8f9c4d42df88876f5b1ff07a86f33562f102a01b1}"
EXPECTED_RECEIPT_LIFE_SHA="${LEO_STATE_RECEIPT_PATH_RECEIPT_LIFE_SHA:-3ad156e174f4b37fc805d227a50ca738b2119538adca9b80110256dbdc8c376d}"
EXPECTED_RECEIPT_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_RECEIPT_SUMMARY_SHA:-8fcc42873f1d106d542e93d33223dddd756230e02fb01d4178ac6474049a0835}"
EXPECTED_RECEIPT_SELECTOR_SHA="${LEO_STATE_RECEIPT_PATH_RECEIPT_SELECTOR_SHA:-d442df90aa485a8df91afa40eacff68749218addd94f24d6f4acf8013dd4d4cd}"
EXPECTED_RECEIPT_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_RECEIPT_VERDICT_SHA:-def19a5ef0db86c36fd4749f22e014ed52ff9c32e2ba308a68a735855473de17}"
EXPECTED_LEO_SOURCE_SHA="${LEO_STATE_RECEIPT_PATH_LEO_SOURCE_SHA:-755f5f0a1e803f36b29ead5517086137af3696baf1959ad34bbca940316b8e73}"
EXPECTED_LEO_CORPUS_SHA="${LEO_STATE_RECEIPT_PATH_LEO_CORPUS_SHA:-98b3052353fc30e8bd08d3c2368ca1aaea41f9fb45b5f7cc2c6a17b78a9b4c19}"
EXPECTED_AML_SOURCE_SHA="${LEO_STATE_RECEIPT_PATH_AML_SOURCE_SHA:-a5cdb03356c9a51cbc8cc664333381cb975bd8c38622f30d293bb93e62ecb54d}"
EXPECTED_AML_HEADER_SHA="${LEO_STATE_RECEIPT_PATH_AML_HEADER_SHA:-b333a334658bbd1516cd9be79ca78c9e0cfd8acbfb90372a3c24af32cc0cca4a}"
EXPECTED_DIALOGUE_REPORTER_SHA="${LEO_STATE_RECEIPT_PATH_DIALOGUE_REPORTER_SHA:-35e393658785740430eec603459dac5ec3bfc1dc8bbac37f531de16582fe4c5e}"
EXPECTED_FIXTURE_SOURCE_SHA="${LEO_STATE_RECEIPT_PATH_FIXTURE_SOURCE_SHA:-6876954c90540ed92aa91a8beb47b433cee231207796b7d84c42c9f2dd9afa47}"
EXPECTED_RESERVOIR_SCREEN_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_SCREEN_PLAN_SHA:-99acc8db620252a1d6883549146ee4bc902a0eb190f5fdfa91a4cf1d27ca9a21}"
EXPECTED_RESERVOIR_WARM_RECEIPTS_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_WARM_RECEIPTS_SHA:-04f7f9de293573919a01b40cf85ddd0d2edd239b48e8fb3b5e05bdddc32db85f}"
EXPECTED_RESERVOIR_ENROLLMENT_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_ENROLLMENT_SHA:-5e14da8f8781f683b5025c0816af0c39a13bb759f63f8e1c1e41cb913034c7b4}"
EXPECTED_RESERVOIR_WRITER_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_WRITER_PLAN_SHA:-4f4ad82293f1e370613546f14e2c09b68d31536968c44455dac95df19d938b4e}"
EXPECTED_RESERVOIR_WRITER_RECEIPTS_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_WRITER_RECEIPTS_SHA:-43880603550ccb4420d57e1acc8226397d99624b38cfcf5043e366c45bda35ab}"
EXPECTED_RESERVOIR_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_RESERVOIR_VERDICT_SHA:-a20c9ff49f18dbf4bdcc82dd88a0b3fee1465bcf8eb8f80e6d609f5b454afefc}"
...
EXPECTED_A101_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A101_POLICIES_SHA:-89736f8e4681db85b8c516f8095c16786d2e13ed1edbd4d3203244baff5529ab}"
EXPECTED_A101_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A101_DISCOVERY_PLAN_SHA:-ebe356a8b3055c6467a163a38e3893c115bfd39ca13ab6cff56ac802f013b860}"
EXPECTED_A101_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A101_VALIDATION_PLAN_SHA:-259be3140c58c7706f985283734cc0c57b99d2d46f6221c17ee0adad6c026a82}"
EXPECTED_A101_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A101_DISCOVERY_SUMMARY_SHA:-05daa176f90ece7e6eb94016a9bb8e1122f7df0f1c6b2528e8d68643bb8fbb7a}"
EXPECTED_A101_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A101_SELECTION_SHA:-0933c24077634e0e993a4019c628eecb5331138ebd6a26bde4eed99741c3364b}"
EXPECTED_A101_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A101_VERDICT_SHA:-24053340a58e648b569de83255970334ad4fbb87e2f3d694bb1187203c0ffb29}"
...
EXPECTED_A103_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A103_POLICIES_SHA:-a6a2e5f56ea3b33f166d9ec7869a78dbeebecc7f0545855060bdc7311d254272}"
EXPECTED_A103_SOURCE_RECEIPT_SHA="${LEO_STATE_RECEIPT_PATH_A103_SOURCE_RECEIPT_SHA:-2ccf516531fd8d046cdbd8a9c79f3fda59c5ee49595181244f9f644602325cfd}"
EXPECTED_A103_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A103_DISCOVERY_PLAN_SHA:-4e96a373c7e099f159d7e8655a54c4b55d3668e76c7c97796bada65a17cbb8a0}"
EXPECTED_A103_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A103_VALIDATION_PLAN_SHA:-4e311548121664b65f8988368ca0dcddf5908dc0fc84c35cab09d03249618d98}"
EXPECTED_A103_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A103_DISCOVERY_SUMMARY_SHA:-76d8424893e2a120da82e632b098cdd709b536617030590b3ff3f5a5940e1fed}"
EXPECTED_A103_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A103_SELECTION_SHA:-51d3ab48d0f19dea16a7f6309eb2c86110cc9e47b0b9e320e7ba36b8fb356637}"
EXPECTED_A103_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A103_VERDICT_SHA:-6e7e0b5dd7672006e6296831e5a0bc71c6e4e13351029c7732c3dc66c2b0b192}"
...
EXPECTED_A104_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A104_POLICIES_SHA:-7e0f0587d53651d637674dc73ef1cd69bef396be6f35c55c31101eb8bc915b6d}"
EXPECTED_A104_SOURCE_RECEIPT_SHA="${LEO_STATE_RECEIPT_PATH_A104_SOURCE_RECEIPT_SHA:-0a5d8c07893296ddeb591baabf8c2c32721fe98c499580288a418e747c8973ee}"
EXPECTED_A104_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A104_DISCOVERY_PLAN_SHA:-b4ff5f967346fb796e19e86370fdb5f73639be3fe956d95699398e7f81e2e169}"
EXPECTED_A104_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A104_VALIDATION_PLAN_SHA:-79802ab37ca79bfe669a8c1ef8e836cd5749c4aae151a511289ac1fef2182a46}"
EXPECTED_A104_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A104_DISCOVERY_SUMMARY_SHA:-920f385dfb98b78bb93d60245261ecde4db9003321981a6f96248a546151fe7c}"
EXPECTED_A104_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A104_SELECTION_SHA:-13c87f6f4f16d776994cfcc7ff20288bb3472ee59d1f8e75f6e849b758dea8f6}"
EXPECTED_A104_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A104_VERDICT_SHA:-60b876a9cc510ac7f4f732d0328b26aa76f79c95b46eef47e3268bea62c65520}"
...
EXPECTED_A105_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A105_POLICIES_SHA:-ab3aa8c577b93466b02f657113c654cd4357d4ecf0f09d458f4ebb0cf172f7c4}"
EXPECTED_A105_SOURCE_RECEIPT_SHA="${LEO_STATE_RECEIPT_PATH_A105_SOURCE_RECEIPT_SHA:-ad55334596982dca3cba6b275fc3ead9ab3a4812ee45512b2c101e0610154110}"
EXPECTED_A105_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A105_DISCOVERY_PLAN_SHA:-4476c0b318e5fc418d6eb819b51e9acbc55a95862adbc4cf98c0cd81794a4e75}"
EXPECTED_A105_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A105_VALIDATION_PLAN_SHA:-82fc866a958b81c8520933f09836815fb9283fb0d78e88fba0c9cbcc1288d754}"
EXPECTED_A105_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A105_DISCOVERY_SUMMARY_SHA:-00f9f1adb3512f6e066016ee371324b34b58646922ce50b5f0b85803f2daab6f}"
EXPECTED_A105_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A105_SELECTION_SHA:-da33255ff64af6b03c69258ac04eab40bd4f928c32aeeca4d9559978a299efdd}"
EXPECTED_A105_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A105_VERDICT_SHA:-689d2a884897eaf48041f0ec004fcc836474a86a4f0eea2da71ac56356968722}"
...
EXPECTED_A106_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A106_POLICIES_SHA:-ab3aa8c577b93466b02f657113c654cd4357d4ecf0f09d458f4ebb0cf172f7c4}"
EXPECTED_A106_DESIGN_SHA="${LEO_STATE_RECEIPT_PATH_A106_DESIGN_SHA:-2364fc67b61764c5f4ab5232b6bc028116e84a634c169a0a157f69c2743b89ea}"
EXPECTED_A106_SOURCE_RECEIPT_SHA="${LEO_STATE_RECEIPT_PATH_A106_SOURCE_RECEIPT_SHA:-816b16d88adfc2fa8ea478ea3a047aaae3e675063dfdfb21204af9f37d34473d}"
EXPECTED_A106_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A106_DISCOVERY_PLAN_SHA:-b1b5e0b15d7fc7309f1993e986a8887ec5910bbcb18231b4794b3929d7f70221}"
EXPECTED_A106_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A106_VALIDATION_PLAN_SHA:-75fb4a949636787b8e37cf1ead9cb49c906256b71d5bc80dce857f726a3f38a4}"
EXPECTED_A106_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A106_DISCOVERY_SUMMARY_SHA:-f75bbc50e8a01296d5098f98f415bc556bdeaf60bb3328a89e310e8f5b5bdce2}"
EXPECTED_A106_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A106_SELECTION_SHA:-6ab08012cd7438e3e13651685a1a872fde61551909432452b903f4073612d32e}"
EXPECTED_A106_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A106_VERDICT_SHA:-46ffc17fdc85413ef607467e3eb2c6a199e56f142ffb020f65253770b1059c79}"
...
EXPECTED_A107_POLICIES_SHA="${LEO_STATE_RECEIPT_PATH_A107_POLICIES_SHA:-1fb66525a9253fb290ff9499ab2c68eb50a6c1f2a9bac04650784964839d4f03}"
EXPECTED_A107_DESIGN_SHA="${LEO_STATE_RECEIPT_PATH_A107_DESIGN_SHA:-df452ccf3adfd84bb25397f5fbc0fd20c6f6f89ab7e2039d1a0ca288f7fb5460}"
EXPECTED_A107_SOURCE_RECEIPT_SHA="${LEO_STATE_RECEIPT_PATH_A107_SOURCE_RECEIPT_SHA:-aec21cafcd86565376b88c95836e5122fd84f8b7e8429039569f41102e4bfa9e}"
EXPECTED_A107_ELIGIBILITY_SHA="${LEO_STATE_RECEIPT_PATH_A107_ELIGIBILITY_SHA:-1a810ef004e958962c75092b70046b8904526ecac2bfb412b0eb646bb0f25f9c}"
EXPECTED_A107_DISCOVERY_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A107_DISCOVERY_PLAN_SHA:-1ed6f34695340e9ec51496c00e6bd21819ab6b0bb793fa23e69370bd3dc15976}"
EXPECTED_A107_VALIDATION_PLAN_SHA="${LEO_STATE_RECEIPT_PATH_A107_VALIDATION_PLAN_SHA:-b346a479df49cc428a29ba82c65b56596c9a0cd02123ab3e428c50cddea50af8}"
EXPECTED_A107_DISCOVERY_SUMMARY_SHA="${LEO_STATE_RECEIPT_PATH_A107_DISCOVERY_SUMMARY_SHA:-4e44193ed17e8ec277f13631f786b81abf14f4a3447de6a5f14c66bf63cbf59c}"
EXPECTED_A107_SELECTION_SHA="${LEO_STATE_RECEIPT_PATH_A107_SELECTION_SHA:-17fafb230fdccc028cf28710668f5971ce43da7d97bbd67017889b44cb0fc767}"
EXPECTED_A107_VERDICT_SHA="${LEO_STATE_RECEIPT_PATH_A107_VERDICT_SHA:-7d37146aa4fe3e8144e01c84656a0839b3a1c01027181c999d6b214ef23b3999}"

case "$JOBS" in
    ''|*[!0-9]*|0) printf 'invalid road delayed-receipt-path jobs: %s\n' "$JOBS" >&2; exit 2 ;;
esac
...
seal "$CANDIDATES" "$EXPECTED_CANDIDATES_SHA" "A.108 reservoir candidates"
seal "$WARM_CASES" "$EXPECTED_WARM_CASES_SHA" "A.108 warm cases"
seal "$WRITER_CASES" "$EXPECTED_WRITER_CASES_SHA" "A.108 writer cases"
seal "$REPORTER" "$EXPECTED_REPORTER_SHA" "A.108 reservoir reporter"
seal "$PLANNER" "$EXPECTED_PLANNER_SHA" "A.108 Williams planner"
seal "$PROSPECTIVE" "$EXPECTED_PROSPECTIVE_SHA" "A.108 prospective runner"
seal "$RESERVOIR_WRAPPER" "$EXPECTED_RESERVOIR_WRAPPER_SHA" "A.108 reservoir wrapper"
seal "$ELIGIBILITY_REPORTER" "$EXPECTED_ELIGIBILITY_REPORTER_SHA" "A.108 eligibility reporter"
seal "$RECEIPT_REPORTER" "$EXPECTED_RECEIPT_REPORTER_SHA" "A.108 receipt reporter"
seal "$RECEIPT_LIFE" "$EXPECTED_RECEIPT_LIFE_SHA" "A.108 receipt life reducer"
seal "$RECEIPT_SUMMARY" "$EXPECTED_RECEIPT_SUMMARY_SHA" "A.108 receipt summary"
seal "$RECEIPT_SELECTOR" "$EXPECTED_RECEIPT_SELECTOR_SHA" "A.108 receipt selector"
seal "$RECEIPT_VERDICT" "$EXPECTED_RECEIPT_VERDICT_SHA" "A.108 receipt verdict"
seal "$LEO_SOURCE" "$EXPECTED_LEO_SOURCE_SHA" "A.108 Leo source"
seal "$LEO_CORPUS" "$EXPECTED_LEO_CORPUS_SHA" "A.108 Leo corpus"
seal "$AML_SOURCE" "$EXPECTED_AML_SOURCE_SHA" "A.108 AML source"
seal "$AML_HEADER" "$EXPECTED_AML_HEADER_SHA" "A.108 AML header"
seal "$DIALOGUE_REPORTER" "$EXPECTED_DIALOGUE_REPORTER_SHA" "A.108 dialogue reporter"
seal "$FIXTURE_SOURCE" "$EXPECTED_FIXTURE_SOURCE_SHA" "A.108 geometry fixture"
...
if [ ! -d "$RESERVOIR" ]; then
    [ "$AGGREGATE_ONLY" = 0 ] || {
        printf 'receipt path reservoir source missing during aggregate-only replay: %s\n' "$RESERVOIR" >&2
        exit 2
    }
...
for path in "$SCREEN_PLAN" "$WARM_RECEIPTS" "$ENROLLMENT" \
    ...
    [ -s "$path" ] || { printf 'incomplete receipt path reservoir source: %s\n' "$path" >&2; exit 2; }
done
seal "$SCREEN_PLAN" "$EXPECTED_RESERVOIR_SCREEN_PLAN_SHA" "A.108 reservoir screen plan"
seal "$WARM_RECEIPTS" "$EXPECTED_RESERVOIR_WARM_RECEIPTS_SHA" "A.108 reservoir warm receipts"
seal "$ENROLLMENT" "$EXPECTED_RESERVOIR_ENROLLMENT_SHA" "A.108 reservoir enrollment"
seal "$WRITER_PLAN" "$EXPECTED_RESERVOIR_WRITER_PLAN_SHA" "A.108 reservoir writer plan"
seal "$WRITER_RECEIPTS" "$EXPECTED_RESERVOIR_WRITER_RECEIPTS_SHA" "A.108 reservoir writer receipts"
seal "$RESERVOIR_VERDICT" "$EXPECTED_RESERVOIR_VERDICT_SHA" "A.108 reservoir verdict"
grep -q '^result=balanced-reservoir-anatomy-admissible$' "$RESERVOIR_VERDICT" || {
    printf 'receipt path reservoir failed its own admission\n' >&2
    exit 2
}
awk -F '\t' '
...
' "$WRITER_CASES" "$ENROLLMENT" "$WRITER_PLAN" || {
    printf 'receipt path reservoir does not balance the scored calendar\n' >&2
    exit 2
}
...
FIXTURE="$OUT/road-delayed-receipt-path-fixture"
...
write_policies() {
    ...
    printf 'receipt-path-light\t0.10\t1.00\t0.25\t0.25\t1\t1\t1\n'
    printf 'receipt-path-gentle\t0.25\t1.00\t0.25\t0.25\t1\t1\t2\n'
}

write_design() {
    printf 'constraint\tvalue\n'
    printf 'calendar\tpaired-williams8\n'
    printf 'reservoir-generation\tr2-after-zero-receipt-r1\n'
    ...
    printf 'signed-receipt\tboundary-target-minus-boundary-source\n'
    printf 'receipt-residual\tafter-signed-path-control\n'
...
if [ "$AGGREGATE_ONLY" = 1 ]; then
    for path in "$DISCOVERY_PLAN" "$VALIDATION_PLAN" "$POLICIES" "$DESIGN" \
        ...
        [ -s "$path" ] || { printf 'incomplete delayed-receipt-path run: %s\n' "$path" >&2; exit 2; }
    done
    write_discovery_plan | cmp -s - "$DISCOVERY_PLAN" || { printf 'A.108 discovery plan diverged\n' >&2; exit 2; }
    write_validation_plan | cmp -s - "$VALIDATION_PLAN" || { printf 'A.108 validation plan diverged\n' >&2; exit 2; }
    write_policies | cmp -s - "$POLICIES" || { printf 'A.108 policy ledger diverged\n' >&2; exit 2; }
    write_design | cmp -s - "$DESIGN" || { printf 'A.108 design ledger diverged\n' >&2; exit 2; }
    write_source_receipt | cmp -s - "$SOURCE_RECEIPT" || { printf 'A.108 source receipt diverged\n' >&2; exit 2; }
    write_eligibility | cmp -s - "$ELIGIBILITY" || { printf 'A.108 eligibility ledger diverged\n' >&2; exit 2; }
else
...
if [ "${LEO_STATE_RECEIPT_PATH_PLAN_ONLY:-0}" = 1 ]; then
...
[ -n "$selected" ] || { printf 'A.108 selection is empty\n' >&2; exit 2; }

if [ "$selected" != none ]; then
    { sed -n '1p' "$POLICIES"; awk -F '\t' -v selected="$selected" '$1 == selected' "$POLICIES"; } \
        > "$SELECTED_POLICY"
    [ "$(wc -l < "$SELECTED_POLICY" | tr -d ' ')" -eq 2 ] || {
        printf 'selected delayed-receipt-path policy is not unique\n' >&2; exit 2;
    }
    if [ "$AGGREGATE_ONLY" != 1 ]; then
