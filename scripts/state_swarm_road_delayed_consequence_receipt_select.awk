# A.107: nominate a delayed receipt only when it beats every matched control.
...
NR == 1 {
    if (NF != 42 || $1 != "candidate" || $4 != "cohort" ||
        $7 != "raw_life_wins" || $42 != "holdout_mean_symmetric_gain") fail()
    next
}
...
END {
    ...
    print "candidate", "strength", "rank", "discovery_lives", \
        ...
        "texture_life_wins", "symmetric_life_wins", "mean_raw_ce_gain", \
    ...
    if (selected)
        print selected, best_strength, best_rank, best_lives, best_receipts, \
            ...
            best_symmetric_wins, best_raw_gain, best_raw_brier, \
        ...
        print "none", 0, 0, expected, 0, 0, 0, 0, 0, "0.000000000", \
            ...
            "0.000000000", "0.000000000", "0.000000000", "0.000000000", \
            "0.000000000", "0.000000000", "0.000000000", "0.000000000", \
            "0.000000000", 0, "no-delayed-receipt-candidate"
}
