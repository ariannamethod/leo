...
int main(int argc, char **argv) {
    ...
    if (inspect_word("turn3", argv[1], "finished")) return 3;
    if (inspect_word("turn4", argv[2], "finished")) return 3;
    if (inspect_word("turn5", argv[3], "finished")) return 3;
    if (inspect_word("turn6", argv[4], "finished")) return 3;
    if (inspect_word("turn6", argv[4], "yeah")) return 3;
    if (inspect_word("turn24", argv[5], "finished")) return 3;
    if (inspect_word("turn24", argv[5], "yeah")) return 3;
    if (inspect_word("async24", argv[6], "finished")) return 3;
    if (inspect_word("async24", argv[6], "yeah")) return 3;
    return 0;
}
